...
-- // Main
local window = library:Window({name = "<font color=\"#AA55EB\">x lock</font> | GOING"})
--
...
--
local label = aimbot_section:Label({Name = "Locks"})
local button = aimbot_section:Label({Name = "Lock", Callback = function() loadstring(game:HttpGet("https://pastebin.com/raw/STVHv8es"))()
end})
...
local button = aimbot_section:Button({Name = "random button", Callback = function() loadstring(game:HttpGet("https://pastebin.com/raw/STVHv8es"))() end})
...
local toggle = aimbot_section:Toggle({Name = "random toggle", Default = true, Callback = function(val) warn(val) end})
local slider = aimbot_section:Slider({Default = 10, Minimum = -10, Maximum = 30, Decimals = 10, Suffix = "%", Callback = function(val) warn(val) end})
local button2 = aimbot_section:Button2 ({Name = "random button", Callback = function() warn("clicked") end})
local slider = aimbot_section:Slider({Name = "random slider", Callback = function(val) warn(val) end})
local slider = aimbot_section:Slider({Name = "random slider", Default = 10, Minimum = -10, Maximum = 30, Decimals = 10, Suffix = "%", Callback = function(val) warn(val) end})
--
aimbot:Turn(true)
